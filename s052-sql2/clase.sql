...
--Fecha de contratacion del empleado mas antiguo y el empleado mas "nuevo"
...
--Obtener datos especificos de mes, anio
...
/*
MUESTRE EL NOMBRE DEL EMPLEADO, EL SALARIO DEL EMPLEADO, EL NOMBRE DEL DEPARTAMENTO AL QUE PERTENECE, EL NOMBRE DE SU ROL 
Y LA CIUDAD DONDE TRABAJA
*/
